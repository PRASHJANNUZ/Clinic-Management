...
<div id="login-container">
  ...
  <form id="loginForm" action="ReportServlet" method="post">
    ...
    <br><br>
    <label for="password">Required test &emsp;&emsp;:</label>
    <input type="text" id="phoneno" name="test" required>
	<br><br>
	<label for="medicine">Prescription &emsp;&emsp;&emsp;:</label>
	    <textarea name="medicine" required id="medicine" placeholder="Enter prescription here"  style="height:25px"></textarea>
	<br><br>
	<label for="appointmentdate">Date&emsp;&emsp;&emsp;&emsp;:</label>
	<input type="date" id="appointmentdate" name="reportdate" required>
	<br><br>
